      ...
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        {resultImage && (
          <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
            ...
            <a
              className="px-8 py-2.5 text-white text-sm bg-gradient-to-tr from-violet-600 via-pink-500 to-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700"
              href={resultImage}
              download
            >
              Download image
